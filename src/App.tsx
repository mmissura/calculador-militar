...
function App() {
  ...
  return (
    <div className="w-full">
      <header className="text-center py-10 flex flex-col justify-center items-center bg-linear-to-b from-orange-400 to-orange-500 mb-6 p-4">
        <img src={LogoBombeiro} alt="Logo Bombeiros" className="w-28 mb-4" />
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="2xl:max-w-1/2 xl:max-w-1/2 lg:max-w-1/2 w-full p-6 mx-auto">
          <div className="w-full flex flex-col justify-center">
            <label className="block text-sm text-orange-400 mb-1 font-semibold">
            ...
            <input
              ...
              {...register('dataIngresso', { required: true })}
          ...
          <>
            ...
            <div className="bg-white p-6 rounded-md shadow-md w-full mb-6">
              <div className="grid xl:grid-cols-12 md:grid-cols-12 gap-4">
                ...
                <div className="xl:col-span-3 md:col-span-4 col-span-12 border p-4 border-pink-400">
            ...
            <div
              className="bg-white p-6 rounded-md shadow-md w-full mb-6"
              id="result"
            >
              <div className="grid xl:grid-cols-12 md:grid-cols-12 gap-4">
                ...
                <div className="xl:col-span-4 md:col-span-4 col-span-12  border p-4 border-pink-400">
                  <label className="text-sm text-slate-700 mb-1 font-semibold flex gap-1 items-center">
